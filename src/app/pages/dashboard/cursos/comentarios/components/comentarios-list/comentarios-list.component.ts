...
export class ComentariosListComponent implements OnInit, AfterViewInit {
  ...
  private settingDatatables(): void {
    this.dtOptions = {
      ...
      ajax: (datatablesParameters: any, callback): void => {
        ...
        this.ComentariosService.getDatatablesComentarios(datatablesParameters, queryParams)
