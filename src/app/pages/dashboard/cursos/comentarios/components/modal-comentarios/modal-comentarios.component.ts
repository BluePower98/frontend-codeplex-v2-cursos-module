...
export class ModalComentariosComponent implements OnInit {@ViewChild(ComentariosListComponent, {static: false}) ComentariosListComponent: ComentariosListComponent
...
opcionEditar:boolean = false;
  ...
  constructor(
    ...
    ngOnInit(): void {
      ...
      // this.f.fecha.patchValue(fecha2);
