...
export class EspecialidadesListComponent implements OnInit, AfterViewInit  {
  ...
  private settingDatatables(): void {
    this.dtOptions = {
      ...
      ajax: (datatablesParameters: any, callback): void => {
        ...
        this.EspecialidadesService.getDatatablesEspecialidades(datatablesParameters, queryParams)
      ...
      columns: [
        ...
        },
        {
          ...
          render: dtUtils.renderEllipsisText(90),
        },
        {
          title: 'Activo',
          data: 'activo',
        ...
        },
        {
          ...
          render: dtUtils.renderEllipsisText(5),
        }
      ],
