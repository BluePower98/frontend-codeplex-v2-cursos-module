...
@Component({
  ...
  styleUrls: ['./instructores-list.component.scss']
})
export class InstructoresListComponent implements OnInit, AfterViewInit {
  ...
  private settingDatatables(): void {
    this.dtOptions = {
      ...
      ajax: (datatablesParameters: any, callback): void => {
        ...
        this.InstructoresService.getDatatablesInstructores(datatablesParameters, queryParams)
